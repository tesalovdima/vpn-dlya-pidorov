...
> **Логин и пароль сохраняются автоматически** (установщик записывает их в RAS
> через `RasSetCredentials` — то же, что галочка «Сохранить данные для входа»).
> При включении VPN в Параметрах или в трее Windows **ничего спрашивать не будет**.
